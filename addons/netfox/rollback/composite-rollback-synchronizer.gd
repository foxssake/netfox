@tool
extends Node
class_name CompositeRollbackSynchronizer
...
func _connect_signals() -> void:
	...
	NetworkTime.after_tick.connect(_transmit_input) # Transmit
	NetworkTime.after_tick.connect(_trim_history) # History
	NetworkRollback.before_loop.connect(_notify_resim) # Simulate
	NetworkRollback.on_prepare_tick.connect(_restore_tick) # History
	...
	NetworkRollback.on_record_tick.connect(_broadcast_tick) # Transmit
	...
	NetworkRollback.after_loop.connect(_reset_resim) # Simulate
...
func _disconnect_signals() -> void:
	...
	NetworkRollback.on_prepare_tick.disconnect(_restore_tick)
...
func _restore_tick(tick: int) -> void:
	# Prepare state
